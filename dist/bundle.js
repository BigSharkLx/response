...
/******/ 	var hotCurrentHash = "f4e6aee4ae77d71647f2"; // eslint-disable-line no-unused-vars
...
exports.default = function () {
  ...
  try {
    for (var _iterator = photo[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      //  下方导航按钮
      var dotsOnmouseOver = function dotsOnmouseOver(i, lib) {
  ...
  function changePhoto() {
    ...
    try {
      for (var _iterator2 = photo[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var _component = __webpack_require__("./src/js/component.js");
...
if (process.env.NODE_ENV !== 'production' && module.hot) {
    module.hot.accept("./src/js/component.js", function () {
        var nextComponent = (0, _component2.default)();
